...
namespace Beehouse.Essentials.Services
{
    ...
    /// </summary>
    /// <typeparam name="TIndividualEntity">Entity type.</typeparam>
    public class IndividualService<TIndividualEntity>: Service<TIndividualEntity>, IIndividualService<TIndividualEntity> where TIndividualEntity : IndividualEntity
    {
        ...
        public IndividualService(DbContext context, IHttpContextAccessor httpContextAccessor) : base(context, httpContextAccessor)
        {
            // Context accessor
        ...
        public override async Task<TIndividualEntity> GetByIdAsync(string id, bool tracking = false, IQueryable<TIndividualEntity> query = null)
        {
        ...
        /// <param name="query">Additional conditions</param>
        /// <returns></returns>
        public override async Task<ICollection<TIndividualEntity>> GetAsync(bool tracking = false, IQueryable<TIndividualEntity> query = null)
        {
            // Check if have additional conditions. If not, create a new condition.
            if (query is null) query = tracking ? Entities.AsTracking() : Entities.AsNoTracking();
        ...
        /// <param name="query">Additional conditions</param>
        /// <returns></returns>
        public override async Task<SearchResult<TIndividualEntity>> GetAsync(int? page_nullable, int? limit_nullable, bool tracking = false, IQueryable<TIndividualEntity> query = null)
        {
            // Check if have additional conditions. If not, create a new condition.
        ...
        public override async Task<TIndividualEntity> InsertAsync(TIndividualEntity e)
        {
        ...
        public override async Task<TIndividualEntity> UpdateAsync(TIndividualEntity entity, TIndividualEntity old = null)
        {
            // Get old entity
            if(old == null)
        ...
        protected override void ChangeEntityState(EntityEntry<TIndividualEntity> entry)
        {
        ...
        /// <param name="m"></param>
        /// <returns></returns>
        public override async Task<TIndividualEntity> InsertOrUpdateAsync(TIndividualEntity m)
        {
